...
BEGIN TRANSACTION TEST_TR_AUTO_FOR1_CANTIDAD
    ...
    VALUES (100, 'OUT4TIME', 2025, 4, 1, 1, 'NEGRO','1HGCM82633A004352'),
        (101, 'NRVOUS01', 2025, 4, 1, 1, 'BLANCO','JHMFA16586S012837'),
        (102, 'A113PIXA', 2025, 4, 1, 1, 'VERDE','2FTRX18W1XCA92348');
...
BEGIN TRANSACTION TEST_TR_AUTO_FOR1_AÑO
    ...
    INSERT INTO USUARIOS.AUTOMOVIL
    VALUES (100, 'OUT4TIME', 2000, 4, 1, 1, 'AMARILLO','WDBUF56X58B298374');
...
BEGIN TRANSACTION TEST_TR_AUTO_FOR1_DISPONIBLE
	...
	INSERT INTO USUARIOS.AUTOMOVIL
	VALUES (102, 'A113PIXA', 2025, 100, 1, 1,'NARANJA','3N1BC13E89L398271');
	SELECT * FROM USUARIOS.AUTOMOVIL
...
BEGIN TRANSACTION TEST_TR_AUTO_FOR1_DISPONIBLE2
	...
	INSERT INTO USUARIOS.AUTOMOVIL
	VALUES (101, 'A1215468', 2025, 100, 1, 0,'NEGRO','4T1BF3EK2AU198374'),
...
BEGIN TRANSACTION TEST_TR_AUTO_FOR1_DISPONIBLE2
	...
	INSERT INTO USUARIOS.AUTOMOVIL
	VALUES (101, 'A1215468', 2025, 100, 1, 0, 'NEGRO','1G1ZC5ST4GF283741'),
	(102, 'A113PIXA', 2025, 100, 1, 0,'BLANCO','5YJ3E1EA7KF318294');
...
BEGIN TRANSACTION TEST_UPDATE_VIAJE_NO_DISPONIBLE
    ...
    INSERT INTO USUARIOS.AUTOMOVIL
    VALUES (100, 'OUT4TIME', 2025, 4, 1, 0,'NEGRO','SALWR2RV0KA893472');	
